...
# RoundThree.py is the post State finals.
#
...
def pullTruckGoStraightWithCoolArm():
    gyroStraight(targetAngle = 0,  distance = _CM_PER_INCH * 10, speed=50)
    time.sleep(1)
    wheels.move(amount = 10, unit = "in", steering = 0, speed = -10)
...
def _run5Point5():
    # Pulls the Oil Platform truck home
    moveArm(degrees = 140, speed = -75, motor = motorD)
    gyroStraight(distance = 33, speed = 35, backward = False, targetAngle = 0)
    moveArm(degrees = 150, speed = 75, motor = motorD)
    gyroStraight(distance = 27, speed = 35, backward = True, targetAngle = 0)
...
#driverWithFewerArms()
#doRunWithTiming(pullTruckGoStraightWithCoolArm)
#doRunWithTiming(_run5Point5)
raise SystemExit
#endregion
