...
def _fasterRun1():
    ...
    def _hybridCar():
        ...
        if (_driveTillLine(speed=50, distanceInCM=30, target_angle=angle, colorSensorToUse="Left", blackOrWhite="Black") == False):
    ...
    def _goHome():
        ...
        gyroStraight(distance=50, speed = 60, backward = True, targetAngle = angle)
...
def _fasterRun2():
    ...
    def _gotoSmartGrid():
        ...
        if _driveTillLine(speed=straightSpeed, distanceInCM=45, target_angle=angle, colorSensorToUse="Left", blackOrWhite="Black") == False:
        ...
        if _driveTillLine(speed=straightSpeed, distanceInCM=15, target_angle=angle, colorSensorToUse="Right", blackOrWhite="Black") == False:
